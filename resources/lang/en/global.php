...
return [
    ...
    'order'                              => [
        'order_messages'         => [
            'del_accept_msg'                 => '{Delivery} has assigned to pick your order',
            'del_reject_msg'          => '{Delivery} has reject to pick your order',
            'del_pick_complete_msg'               => 'Your order has arrived to laundry',
            'del_drop_complete_msg'               => 'Your order has complete to customer',
            'new_order_msg'               => 'You have new order',
            'shop_accept_msg'                 => 'Your order has accepted',
            'shop_reject_msg'          => 'Laundry has reject to accept your order',
            'shop_complete_msg'               => 'Your order has completed by laundry',
            'del_pick_shop_order'               => '{Delivery} has assigned to pick {Customer} order',
            'del_drop_shop_order'               => '{Delivery} has assigned to pick {Laundry} order',
            'del_pick_cust_order'               => '{Delivery} has assigned for {Customer} order',
        ],
    ],
];
