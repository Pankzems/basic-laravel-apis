    ...
    <div class="card-body">
        <form action="{{ route( 'admin.coupons.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('valid_from') ? 'has-error' : '' }}">
                ...
                <input type="text" id="valid_from" name="valid_from" class="form-control" value="{{ old('valid_from', isset($coupon) ? $coupon->valid_from : '') }}">
            ...
            <div class="form-group {{ $errors->has('valid_to') ? 'has-error' : '' }}">
                ...
                <input type="text" id="valid_to" name="valid_to" class="form-control" value="{{ old('valid_to', isset($coupon) ? $coupon->valid_to : '') }}">
            ...
            <div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
                ...
                <input type="text" id="amount" name="amount" class="form-control" value="{{ old('amount', isset($amount) ? $coupon->amount : '') }}" onKeyUp="this.value=this.value.replace(/[^0-9]/g,'');">
            ...
            <div class="form-group {{ $errors->has('discount') ? 'has-error' : '' }}">
                ...
                <input type="number" id="discount" name="discount" class="form-control" value="{{ old('discount', isset($discount) ? $coupon->discount : '') }}" onKeyUp="this.value=this.value.replace(/[^0-9]/g,'');" min="0" max="100">
            ...
            <div class="form-group {{ $errors->has('attempts') ? 'has-error' : '' }}">
                ...
                <input type="number" id="attempts" name="attempts" class="form-control" value="{{ old('attempts', isset($attempts) ? $coupon->attempts : '') }}" min="0" max="100" onKeyUp="this.value=this.value.replace(/[^0-9]/g,'');">
